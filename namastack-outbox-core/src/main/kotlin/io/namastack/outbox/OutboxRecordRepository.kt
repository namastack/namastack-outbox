...
interface OutboxRecordRepository {
     ...
     * @return List of incomplete outbox records for the record key
     */
     ...
     * @param ignoreRecordsWithPreviousFailure Whether to exclude record keys with previous open/failed events
    ...
    /**
     * Deletes records for a specific record keys and status.
     *
