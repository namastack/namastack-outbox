        ...
        val statusRepository =
            outboxRecordStatusRepository.getIfAvailable()
                ?: throw IllegalStateException(
                    "OutboxRecordStatusRepository bean is missing! The Outbox metrics cannot be registered because no persistence module (e.g. spring-outbox-jpa) is included. Please add a persistence module to your dependencies to enable Outbox metrics.",
                )
