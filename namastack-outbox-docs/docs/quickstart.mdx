...
For production environments, you can disable auto-index creation and manage collections and indexes manually using the provided [mongosh setup script](reference/mongodb-schema.md).
