...
Handwritten handlers use explicit, responsibility-based IDs as the recommended default. The
MongoDB example intentionally retains an autogenerated ID to demonstrate that opt-out.
