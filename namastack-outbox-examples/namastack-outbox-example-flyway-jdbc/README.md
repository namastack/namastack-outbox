# Namastack Outbox - Flyway JDBC Example

This example demonstrates how to use the Namastack Outbox pattern with **Flyway migrations** for manual schema management with the JDBC module.

## What This Example Shows

- Manual schema creation using Flyway migrations instead of automatic schema initialization
...
```bash
./gradlew :namastack-outbox-example-flyway-jdbc:bootRun
```
