...
CREATE INDEX idx_outbox_record_record_key_created
...
CREATE INDEX idx_outbox_record_record_key_completed_created
...
CREATE INDEX idx_outbox_partition_instance_id
