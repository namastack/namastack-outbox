[![Version](https://img.shields.io/badge/version-1.7.3-blue)](https://github.com/namastack/namastack-outbox/releases/tag/v1.7.3)
...
```gradle
dependencies {
    implementation(platform("io.namastack:namastack-outbox-bom:1.7.3"))
