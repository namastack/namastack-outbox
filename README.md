[![Version](https://img.shields.io/badge/version-1.8.0-blue)](https://github.com/namastack/namastack-outbox/releases/tag/v1.8.0)
...
```gradle
dependencies {
    implementation(platform("io.namastack:namastack-outbox-bom:1.8.0"))
