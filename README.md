[![Version](https://img.shields.io/badge/version-1.7.2-blue)](https://github.com/namastack/namastack-outbox/releases/tag/v1.7.2)
...
```gradle
dependencies {
    implementation(platform("io.namastack:namastack-outbox-bom:1.7.2"))
